...
@SpringBootTest
class SpringbootwebmybatisApplicationTests {
    ...
    public void test2(){
        ...
        System.out.println(employee);
        //Employee(id=1, employeeName=张三, email=zhangsan@gmail.com, gender=0, departmentId=11, date=2020-07-14)
    }
    //添加id为6的员工信息
    @Test
    public void test3(){
